...
fn _0001(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{a: "foo", b: "bar"}"#);
...
fn _0002(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{a: "foo", b: {c: "bar", d: {e: "baz"}}}"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0003(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{a: 3, b: 6}"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0004(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{a: 3, b: 3, c: {d: 6}}"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0005(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{foo bar: "foo"}"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0007(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{foo+bar((!!],foo: "foo"}"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0009(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"{foo: "baz"}"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
