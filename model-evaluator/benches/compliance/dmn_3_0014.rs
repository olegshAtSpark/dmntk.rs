...
fn _0001(b: &mut Bencher) {
  ...
  assert_business_knowledge_model(&MODEL_EVALUATOR, invocable_name, &ctx, r#"1"#);
...
fn _0002(b: &mut Bencher) {
  ...
  let invocable_name = "equity36Mo";
  assert_business_knowledge_model(&MODEL_EVALUATOR, invocable_name, &ctx, r#"2.083333333333333333333333333333333"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0003(b: &mut Bencher) {
  ...
  assert_business_knowledge_model(&MODEL_EVALUATOR, invocable_name, &ctx, r#"1.083333333333333333333333333333338"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0004(b: &mut Bencher) {
  ...
  let invocable_name = "monthlyPayment";
  assert_business_knowledge_model(&MODEL_EVALUATOR, invocable_name, &ctx, r#"2.166666666666666666666666666666676"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
