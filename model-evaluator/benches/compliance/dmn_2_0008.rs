...
fn _0002(b: &mut Bencher) {
  ...
  let invocable_name = "payment";
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"562.7073593732659271562143285576524"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0003(b: &mut Bencher) {
  ...
  let invocable_name = "payment";
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"2861.033777003901636716262779605767"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
