...
fn _0001(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"3486784401"#);
...
fn _0002(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"9"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0003(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"null(exponentiation base is not a number)"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
