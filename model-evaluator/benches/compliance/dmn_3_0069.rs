...
fn _0001(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"[1, 2, 3]"#);
...
fn _0012(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"[2, 3]"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0015(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"[100]"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0025(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"[{a: 2}, {a: 3}]"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
...
fn _0027(b: &mut Bencher) {
  ...
  assert_decision(&MODEL_EVALUATOR, invocable_name, &ctx, r#"[{item: 2}, {item: 3}]"#);
  b.iter(|| MODEL_EVALUATOR.evaluate_invocable(invocable_name, &ctx));
}
