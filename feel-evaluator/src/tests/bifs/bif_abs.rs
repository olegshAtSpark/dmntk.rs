...
fn _0011() {
  te_null(
    ...
    &scope!(),
    r#"abs(duration("-P1Y"))"#,
    r#"invalid argument type, expected number, actual type is years and months duration"#,
  );
}
...
fn _0012() {
  te_null(
    ...
    &scope!(),
    r#"abs(null)"#,
    r#"invalid argument type, expected number, actual type is Null"#,
  );
}
...
fn _0013() {
  te_null(
    ...
    &scope!(),
    r#"abs(true)"#,
    r#"invalid argument type, expected number, actual type is boolean"#,
  );
}
...
fn _0014() {
  te_null(
    ...
    &scope!(),
    r#"abs("-57")"#,
    r#"invalid argument type, expected number, actual type is string"#,
  );
}
