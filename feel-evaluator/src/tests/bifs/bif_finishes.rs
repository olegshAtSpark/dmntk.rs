...
#[test]
fn _0002() {
  te_null(false, &scope!(), r#"finishes(20,[1..20])"#, "unimplemented");
}

#[test]
fn _0003() {
  te_null(false, &scope!(), r#"finishes(point: 20,range: [1..20])"#, "unimplemented");
}

#[test]
fn _0004() {
  te_null(false, &scope!(), r#"finishes(range: [1..20], point: 20)"#, "unimplemented");
}

#[test]
fn _0005() {
  te_null(false, &scope!(), r#"finishes(range1: [1..20],range2: [5..20])"#, "unimplemented");
}
